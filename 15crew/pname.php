    ...
    <div class="az-content az-content-dashboard-nine">
      ...
      <div class="az-content-header">
        <div class="az-content-header-top">
          <div>
            <h2 class="az-content-title mg-b-5 mg-b-lg-8"><?php echo $lang["Manage Profile"];?></h2>
          </div>
      ...
      <div class="az-content-body">
        ...
        <!-- form start -->
        <form class="form-horizontal" action="pname2.php" onsubmit="superenginex2(); return false" method="post">
            ...
            <div class="col-md-6 col-sm-12 form-partition">
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="basic-addon1">Profile Name</span>
                </div>
                <input type="text" class="form-control mtgox" style="text-transform:capitalize;" name="name" value="<?php echo $name; ?>" aria-describedby="basic-addon1" required>
              </div><!-- input-group -->
